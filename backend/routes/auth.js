...
router.post('/register', async (req, res) => {
    // 1. รับค่าต่างๆ ที่ผู้ใช้กรอกผ่านหน้าเว็บ (Body)
    ...
    try {
        ...
        await pool.request()
            ...
            .query('INSERT INTO Users (Username, Password, FullName, Email, PhoneNumber, Role) VALUES (@username, @password, @fullName, @email, @phoneNumber, @role)');
